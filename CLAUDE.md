...
5. Пассивные эффекты бесконечны и обновляются при assignment/join/respawn/world-change/wake-up и раз в 6000 тиков. Молоко, `/effect clear` и Blessing снимают их до следующего refresh; conditional-пассивы дополнительно возвращаются на false→true переходе и не снимаются при true→false.
